const sidebarTitlesArray = [
  ...
  [false, '📔 编程笔记', [
    [false, '📁 Python', [
      [false, '📁 Numpy', [
        [false, '📁 初级教程', [
          [true, '📘 安装和导入', "replace('programmingNoteFiles\\\\Python\\\\Numpy\\\\初级教程\\\\1.html'); "],
          [true, '📘 创建数组', "replace('programmingNoteFiles\\\\Python\\\\Numpy\\\\初级教程\\\\2.html'); "],
          [true, '📘 索引和切片', "replace('programmingNoteFiles\\\\Python\\\\Numpy\\\\初级教程\\\\3.html'); "],
          [true, '📘 数组的运算', "replace('programmingNoteFiles\\\\Python\\\\Numpy\\\\初级教程\\\\4.html'); "],
          [true, '📘 数组形状操作', "replace('programmingNoteFiles\\\\Python\\\\Numpy\\\\初级教程\\\\5.html'); "],
          [true, '📘 随机数生成', "replace('programmingNoteFiles\\\\Python\\\\Numpy\\\\初级教程\\\\6.html'); "],
          [true, '📘 进阶操作', "replace('programmingNoteFiles\\\\Python\\\\Numpy\\\\初级教程\\\\7.html'); "]
        ]],
        [false, '📁 高级教程', [
      ...
      [false, '📁 PySide6', [
        [false, '📁 初级教程', [
          [true, '📘 安装和导入', "replace('programmingNoteFiles\\\\Python\\\\PySide6\\\\初级教程\\\\1.html'); "],
          [true, '📘 ', "replace('programmingNoteFiles\\\\Python\\\\PySide6\\\\初级教程\\\\2.html'); "],
          [true, '📘 ', "replace('programmingNoteFiles\\\\Python\\\\PySide6\\\\初级教程\\\\3.html'); "],
        ]],
        [false, '📁 高级教程', [
          [true, '📘 ', "replace('programmingNoteFiles\\\\Python\\\\PySide6\\\\高级教程\\\\1.html'); "]
        ]]
      ]],
      [false, '📁 Tkinter', [
        [true, '📘 暂无笔记', ""]
...
function openSidebar() {
  ...
  setTimeout(() => { sidebar.style.left = '-19rem'; }, 10);
  setTimeout(() => { sidebar.style.left = '-18rem'; }, 20);
  setTimeout(() => { sidebar.style.left = '-17rem'; }, 30);
  setTimeout(() => { sidebar.style.left = '-16rem'; }, 40);
  setTimeout(() => { sidebar.style.left = '-15rem'; }, 50);
  setTimeout(() => { sidebar.style.left = '-14rem'; }, 60);
  setTimeout(() => { sidebar.style.left = '-13rem'; }, 70);
  setTimeout(() => { sidebar.style.left = '-12rem'; }, 80);
  setTimeout(() => { sidebar.style.left = '-11rem'; }, 90);
  setTimeout(() => { sidebar.style.left = '-10rem'; }, 100);
  setTimeout(() => { sidebar.style.left = '-9rem'; }, 110);
  setTimeout(() => { sidebar.style.left = '-8rem'; }, 120);
  setTimeout(() => { sidebar.style.left = '-7rem'; }, 130);
  setTimeout(() => { sidebar.style.left = '-6rem'; }, 140);
  setTimeout(() => { sidebar.style.left = '-5rem'; }, 150);
  setTimeout(() => { sidebar.style.left = '-4rem'; }, 160);
  setTimeout(() => { sidebar.style.left = '-3rem'; }, 170);
  setTimeout(() => { sidebar.style.left = '-2rem'; }, 180);
  setTimeout(() => { sidebar.style.left = '-1rem'; }, 190);
  setTimeout(() => { sidebar.style.left = '0rem'; }, 200);
}
